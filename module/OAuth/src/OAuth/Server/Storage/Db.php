...
class Db implements OAuth2Storage\AuthorizationCodeInterface,
    OAuth2Storage\AccessTokenInterface,
    OAuth2Storage\ClientCredentialsInterface,
    OAuth2Storage\UserCredentialsInterface,
    OAuth2Storage\RefreshTokenInterface,
    OAuth2Storage\JwtBearerInterface,
    OAuth2Storage\ScopeInterface,
    OAuth2Storage\PublicKeyInterface
{
    protected $db;
    protected $config;
    ...
    {
        $this->db = $adapter->driver->getConnection()->getResource();
